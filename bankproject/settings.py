...
SECRET_KEY = "django-insecure---+u4j8evw(^6crq!q5@mlxz$w57f6d4ufqk^)xjt*nb=^rmt*"
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # Correctly placed for static files
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "banking"),
